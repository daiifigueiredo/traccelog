...
const pathValue = './logs/logPath_log/';
const logDirectory = path.join(pathValue);
...
describe('#Testar geracao de logs rastreaveis na aplicacao', function() {
    ...
    describe('testar a função log Request', function() {
        ...
        logger.logPathRequest(pathValue,"56789",{data:{app:"tracceLog Request"}});  
    ...
    describe('testar a função log Response', function() {
        ...
        logger.logPathResponse(pathValue,"45678",{data:{app:"tracceLog Response"}});  
    ...
    describe('testar a função log Error', function() {
        ...
        logger.logPathError(pathValue,"12345",{data:{app:"tracceLog Error"}});      
